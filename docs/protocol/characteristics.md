...
- **Confidence**: Confirmed
- **Implementation status**: Implemented, including the write side (CMD-001), in `components/volcano/volcano.cpp`. Verified against real hardware.
